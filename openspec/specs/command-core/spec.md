...
The command-core capability provides a shared library of command functions and a `CmdResult` return protocol that both the CLI and REPL can call, eliminating code duplication between the two interfaces.
