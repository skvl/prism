...
The onboarding capability provides an interactive, terminal-based tutorial (`prism tutor`) that teaches new users — especially those new to Personal Knowledge Management (PKM) — how to use Prism through guided, hands-on lessons in a sandboxed vault.
...
The tutorial SHALL deliver specified lesson content for each of the 7 lessons.
